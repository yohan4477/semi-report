...
TRACKS = {
    ...
    'voice': [
        ('먼저 읽을 것', '실시간에서 무엇이 값을 가르나',
         ['knH3fmGAteQ']),
        ('무엇을 붙여 무엇을 내나', '알아듣는 모델과 만드는 모델을 잇는 자리',
         ['Bc6Ojl2XS1w', 'GIRpQEfYf3U']),
        ('만드는 쪽 안을 열면', '그림과 영상이 실제로 어떻게 만들어지나',
         ['xOP1PM8fwnk']),
    ],
    'product': [
        ('먼저 읽을 것', '이 일이 누구 것이고 무엇으로 재나',
         ['NKwIX3CiRgU']),
        ('만드는 자리는 어디까지 왔나', '프롬프트 한 줄로 앱이 서는 데까지',
         ['fgkXEIbZpGc']),
    ],
    'train': [
        ('먼저 읽을 것', '무엇이 막혀 있고, 왜 답하기 전에 더 생각시키나',
         ['8EQo4J2BWKw']),
        ('남의 환경에서 배우게 하려면', '가중치를 바꿔 얻는 것과, 보상이 뚫리는 자리',
         ['p1CmPZ2j6Lk', 'k35LeKZEhiE']),
    ],
    'code': [
