...
CAPTION = {
    'SERIES': ('2026년 6월부터 8월까지 미국 국채금리가 어떻게 움직였나', rf.FIG_SERIES,
               '점은 전부 원문에 날짜와 함께 적힌 값이고, 점 사이 선은 이어 본 것입니다. '
               '코퍼스에 있는 값만 썼습니다 — FRED 같은 바깥 시계열을 끌어오지 않았습니다. '
               '그래서 점이 성깁니다. 8월 18일 30년물을 두 편이 5.31%와 5.34%로 다르게 적어 둘 다 '
               '찍었습니다. 8월 19일 재무부 바이백 발표에 30년물이 9bp 내렸다가 다음 날 발표 이전 '
               '수준을 넘어 되올라온 것이 이 그림에서 가장 짧고 분명한 대목입니다. 기준금리는 이 '
               '구간 내내 3.50~3.75% 동결이라 선으로 안 그렸습니다.'),
