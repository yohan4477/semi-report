...
CAPTION = {
    ...
    'KRW': ('저자가 센 6,700억은 대부분 에너지다', tf.FIG_KRW,
            '왼쪽이 결과이고 오른쪽이 그것을 이루는 항입니다. 동그라미는 두 항을 '
            '묶는 셈이고, 값은 전부 저자가 센 추정치입니다. ① 2031년 완공 예정인 '
            '가스전에서 한국이 4대 6으로 받는다고 볼 때의 몫입니다. ② 미국산 비중을 '
            '14%에서 30%로 올릴 때 늘어나는 연 수입액입니다. ③ 에너지가 아닌 항은 '
            '이 하나뿐입니다.'),
