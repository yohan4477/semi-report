...
DONE = {
    '7dfbDm8Fwa8': ('2026-08-27', '부동산/[260826] 서울 한복판에 63빌딩 20개 분량이 남았다 - 오피스와 아파트 - 김열매.md'),
    'gRNmCDgqQIw': ('2026-08-27', '부동산/[260821] 선분양이 키운 2천조 가계부채 - 박선영.md'),
    'LUeLYNZqxs0': ('2026-08-27', '부동산/[260820] 용산공원에 청년주택을 지을 수 있나 - 장순원.md'),
    'ilfqdi6uYzw': ('2026-08-27', '부동산/[260818] 빌라를 10평 더 짓게 해주는 대책의 실효 - 장순원.md'),
    'pCZvT3g5vTs': ('2026-08-27', '부동산/[260322] 이삿날 하루의 구멍을 40년간 못 막은 이유 - 전세사기 - 장순원.md'),
