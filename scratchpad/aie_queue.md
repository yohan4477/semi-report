...
rag 둘은 사실표가 있다. 바로 쓰면 된다. 이 둘을 끝내면 rag 섹션이 닫히고
「읽는 차례」를 세울 차례가 된다 — `TRACKS`에 갈래를 넣는다.

| 섹션 | 영상 ID | 사실표 | 제목 첫머리 |
|---|---|---|---|
| rag | ROfHHJmumcc | **있음** | 데이터가 차이를 만든다 … |
| rag | -tgQa8Fzf80 | **있음** | 지식그래프 RAG, 언제 … |
