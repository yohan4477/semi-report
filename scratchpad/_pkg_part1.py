...
CAPTION = {
    'RETICLE': ('레티클 한 장이 다이의 최대 크기이고, 패키지는 그보다 커야 한다', pf.FIG_RETICLE,
                '작은 사각형 하나가 노광기가 한 번에 새기는 최대 면적입니다. H100 이 이미 그 한계에 닿아 있었고 '
    ...
    'BRANCH': ('CoWoS 세 갈래와 EMIB — 가운데 층을 무엇으로 두나', pf.FIG_BRANCH,
               '넷을 같은 꼴로 그리고 가운데 층만 다르게 했습니다. 짙은 칸이 실리콘입니다. 층 구분과 이름은 Semi Doped 진행자의 '
               '설명(2026-06)이고 값은 없습니다.'),
    ...
    'MONEY': ('InFO 를 CoWoS 가 넘어섰다', pf.FIG_MONEY,
              'SemiAnalysis 추정입니다(2026-01). 2025년 InFO 는 같은 원문이 한 곳에 84억 달러, 다른 곳에 38억 달러로 적어 둘 다 '
              '그렸고 뒤엣것을 점선으로 뒀습니다. 막대 높이는 값에 비례합니다.'),
    'EMIBT': ('브리지에 구멍을 뚫자 전력이 곧장 올라간다', pf.FIG_EMIBT,
              '화살표가 전력이 가는 길입니다. 화살표 개수는 경로를 보이려고 '
    ...
    'BASE': ('HBM4 베이스 다이 — 짙은 칸을 누구 공정으로 굽나', pf.FIG_BASE,
             '줄마다 같은 HBM 을 그리고 그 회사가 고른 베이스 다이 공정만 짙게 했습니다. 위에 '
