...
FIG_HIERSEQ = _svg(640, 462, '사람이 준 일 하나를 판단층이 단계로 쪼개 아래층에 넘긴다',
    ...
    _a(318, 166, 322, 166),
    _box(326, 132, 128, 68, ['③ 반사층', '어깨를 이만큼,', '팔꿈치를 이만큼'], 'var(--accent)', 1.8),
    _a(458, 166, 462, 166),
    _lt(466, 96, '④ 컵을 들었다'),
    ...
    _a(318, 336, 322, 336),
    _box(326, 302, 128, 68, ['⑦ 반사층', '어깨를 저만큼,', '팔꿈치를 저만큼'], 'var(--accent)', 1.8),
    _a(458, 336, 462, 336),
...
def summary_layer():
    figs = [('관절까지 가는 네 갈래', FIG_ROUTE4,
            ...
            ('층 사이에 무엇이 오가나', FIG_HIERSEQ,
             ...
             '<b>반사층</b>이다. 팔이 실제로 움직이는 것은 오른쪽 칸에서다. 아랫줄을 따로 그린 것은 '
             ...
             '빨간불이 켜지는 식으로 계획을 바꿔야 할 때는 반사층이 아니라 위층이 멈추라고 정한다.'),
