...
CAPTION = {
    ...
    'PHASE': ('800볼트 직류 전환의 네 단계와 단계별 효율', pf.FIG_PHASE,
              '네 상자가 전부 같은 크기입니다. 다른 것은 안에 적힌 효율과 그 단계가 무엇을 '
              '걷었나뿐입니다. 단계마다 변환이 몇 개 남는지는 그리지 않았습니다 — 원문이 센 '
              '것은 1·2단계의 7단계와 5단계뿐입니다. 값은 전부 원문에 있습니다'
              '(전력-260526 L560). 네 번째 칸의 테두리가 짙은 것은 그 자리가 뒤에 나올 '
              '절감치 어긋남의 근거이기 때문입니다.'),
