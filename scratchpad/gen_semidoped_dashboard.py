...
JAL = {
    ...
    'report': [
        ...
        ('toc', [
            ('설계 기준', '대비', [('①', '무엇을 기준으로 잡았나')]),
            ('벤치마크', '부분 나눔', [('②', '무엇으로 쟀고 무엇이 안 재졌나')]),
            ('메모리 배치', '문제와 처방', [('③', '대역폭이 있는데 왜 못 쓰나')]),
            ('스케일업 도메인', '층위', [('④', '칩 몇 개가 한 덩어리로 도나')]),
            ('칩 분업', '조건 갈림', [('⑤', '왜 프리필·디코드 칩을 안 나눴나')]),
        ...
        ('p', '잰 도구는 SemiAnalysis 의 <b>Inference X</b>다. 파워를 정규화해 공개 비교했고, '
              ...
              '본다는 이유를 댔다. 결과는 DeepSeek R1(6,710억 파라미터)에서 파레토 프론티어를 '
              '새로 그은 것, GPT-OSS(1,200억)에서 <b>사용자당 초당 1,000토큰 이상</b>을 낸 것, '
              '그리고 700W 로 GB200 약 1,200W 보다 훨씬 적게 먹은 것이다.'),
        ('p', '안 재진 것이 셋 남는다. 벤치마크의 입출력이 8K·1K 로 짧아 100만 토큰급 긴 '
              '문맥은 아직 안 나왔고, agentic 워크로드는 테스트하지 않아 별도 AgentX 로 재겠다고 '
              '했다. 견준 상대도 세대가 다르다 — 할라페뇨는 HBM4 를 쓰고 블랙웰·MI355 는 '
              'HBM3E 다. 진행자들이 스스로 Vera Rubin·Helios 와 견줘야 공평하다고 말한다.'),
        ('tbl', ('무엇이 재졌고 무엇이 안 재졌나',
                 ['재는 것', '나온 값', '언제 것 · 성격'],
                 [['DeepSeek R1 6,710억', '파레토 프론티어를 새로 그었다',
                   '2026-08 · 발표 슬라이드'],
