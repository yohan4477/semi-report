...
JAL = {
    ...
    'report': [
        ...
        ('p', '<b>그래서 무엇이 나왔나.</b> 이 틈이 Cerebras·Groq 처럼 HBM 대신 SRAM(칩 안에 '
              ...
              '초당 약 4,000토큰을 낸다고 진행자가 전한다. 발표에서 나온 문장이 이 절을 그대로 '
        ...
        ('p', '나온 것은 셋이다. ① <b>DeepSeek R1</b>(중국 딥시크가 가중치를 공개한 모델, '
              ...
              '시스템보다 더 높은 데까지 간다. ② <b>GPT-OSS</b>(오픈AI 가 '
              '가중치를 공개한 모델, 1,200억 파라미터)에서 사용자당 초당 1,000토큰을 '
              '넘겼다. 진행자들은 이 구간을 통상 GPU 가 못 가는 <b>SRAM 영역</b>이라 부른다 — '
              '앞 절에서 Cerebras·Groq 가 맡던 자리다. ③ 700W 로 '
        ...
        ('p', '이 카드가 절로 세우지 않은 마디도 남는다. 발표자 셋이 누구인지, 무엇을 뺄지가 '
              ...
              '로드맵, 앤트로픽이 아직 자체 칩이 없다는 지적, 이 칩으로 Kimi K2.5 와 Doom 까지 '
              '돌려 보였다는 것, 칩 이름과 행사 이름이 겹친 우연. 평가지표가 옮긴 이야기의 '
              '사슬 밖이라 뺐다.'),
    ],
}
