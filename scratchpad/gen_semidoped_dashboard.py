...
JAL = {
    ...
    'report': [
        ...
        # 행은 견준 주체다. 항목을 행으로 두면 한 주체의 값이 표 전체에 흩어져
        # 「할라페뇨가 무엇을 어떻게 이겼나」를 세로로 못 읽는다
        ('tbl', ('견준 주체별로 무엇이 나왔나',
                 ['주체', '전력', '메모리 세대', 'DeepSeek R1 6,710억',
                  'GPT-OSS 1,200억', '언제 것 · 성격'],
                 [['할라페뇨', '700W', 'HBM4', '파레토 곡선을 새로 그었다',
                   '사용자당 초당 1,000토큰 이상', '2026-08 · 발표 슬라이드'],
                  ['GB200(블랙웰)', '약 1,200W', 'HBM3E', '그전 곡선 — 값은 안 나왔다',
                   '이 구간에 못 간다', '2026-08 · 전력과 판단은 진행자 어림'],
                  ['MI355', '안 나왔다', 'HBM3E', '안 나왔다', '안 나왔다',
                   '2026-08 · 세대만 진행자가 짚었다']])),
