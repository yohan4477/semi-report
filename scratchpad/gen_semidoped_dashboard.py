...
JAL = {
    ...
    'report': [
        ...
        ('p', '<b>전.</b> 칩을 파는 회사가 잣대를 정했다. 엔비디아·AMD 는 총소유비용부터 '
              '본다 — 칩을 사서 굴리는 데이터센터 운영자가 치르는 돈이다.'),
        ('p', '<b>후.</b> 모델을 파는 회사가 칩을 만들자 잣대가 챗을 쓰는 사람이 겪는 것으로 '
              '옮겼다. 지표 둘이다. ① <b>마지막 토큰까지 걸리는 엔드투엔드 지연</b> '
              '② <b>요청당 전기에너지</b>. 둘은 서로 밀어내는 값이라 오픈AI 는 수치 하나를 '
              '내지 않고 늘 파레토 곡선으로 보이겠다고 했다.'),
