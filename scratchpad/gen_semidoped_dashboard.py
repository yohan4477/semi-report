...
JAL = {
    ...
    'report': [
        ...
        ('p', '두 뷰는 서로 다른 말을 하지 않는다. <b>초점이 다를 뿐이다</b> — 전략 쪽은 시장이 '
              '얼마나 커지고 사는 기준이 어떻게 바뀌는지를 보고, 기술 쪽은 GPU 를 왜 놀게 '
              '두면 안 되고 그 일이 어디서 밀리는지를 본다. 같은 사실을 다른 층에서 짚는다.'),
        ('p', '그래서 이 편을 읽고 지켜볼 것이 셋이다. ① <b>둘에 일을 나눠 주는 층</b>이 '
              '누구 손에서 서는가 ② <b>코어 수를 앞세운 랙</b>이 실제로 얼마나 팔리는가 '
              '③ 비서가 천재의 메모를 직접 보는 <b>코히런시</b>가 어디까지 퍼지는가. '
              '셋째의 구체적인 규격 이름은 원문에 없다.'),
