...
JAL = {
    ...
    'report': [
        ...
        ('p', '값을 한 수로 묶는 자리도 나온다. 진행자 Vik 는 <b>tokens per joule</b>(전기 '
              ...
              '것을 하나로 접는 셈인데, 발표가 그 수를 낸 것은 아니다. 총소유비용 쪽을 겨눈 '
              '말도 하나 전한다 — 엔비디아 젠슨 황이 예전에 「칩을 더 싸게 만들려고 아키텍처를 '
              '고르는 것은 나쁜 설계 결정」이라는 취지로 말했다는 것이다.'),
        ...
        ('p', '핀 하나가 나르는 속도도 같이 오른다. 지금 HBM 은 핀당 초당 10기가비트에서 '
              '16기가비트로 올라가는 중이고, HBM5 는 초당 약 23~24기가비트로 나올 것이라는 '
              '차트가 같은 행사 메모리 세션에 있었다는 것이 진행자 전언이다.'),
        ...
        ('p', '붙이는 장치는 브로드컴 Tomahawk 6 스위치이고, 칩끼리 말을 맞추는 규약은 '
              ...
              '진행자는 이 짜임을 <b>half flattened two-level Clos</b> 라 부른다고 하면서 정확한 '
              '뜻은 아직 소화 중이라고 덧붙인다. 칩 128개가 한 랙이면 2,048개는 약 열여섯 '
              '랙인데, 이 랙 수는 발표에 없고 '
              '진행자가 두 수를 나눠 본 값이다.'),
