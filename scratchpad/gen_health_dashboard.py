...
CARDS = [{
    ...
    'links': LINKS_GLP1,
    'slim_oneliner': ('GLP-1은 먹으면 장에서 나오는 호르몬이다. 인슐린을 늘리고 그만 먹으라고 알린다. 그런데 이 '
                      '호르몬이 붙는 수용체가 뇌에서 <b>원함</b>을 만드는 자리에도 있다. 그래서 줄어드는 것이 '
                      '식욕만으로 끝나지 않는다.'),
    'slim_points': [
    ...
    'slim_points': [
        ...
        '잠시일 뿐이라, 일주일 내내 농도를 유지하는 주사와 견줄 수 없다. 저탄수화물 식단도 같은 이유로 효과가 '
        '미미하다는 것이 그의 설명이다.',
    ],
