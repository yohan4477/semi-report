...
SEC_INFLAM = ('sec-inflam', '01', '만성 염증',
              '염증이 뭔지, 남은 칼로리가 그걸 어떻게 계속 켜 두는지, 숫자로는 어디서 보이는지')
...
CARDS = [{
    'section': SEC_INFLAM,
    'topic': ('market', '염증 · 면역'),
    'title': '염증은 죄가 없다. 그걸 계속 켜 두는 게 남은 칼로리다',
    ...
    'slim_oneliner': ('염증은 몸이 침입자와 싸울 때 나는 현상이다. 감기로 붓고 열이 오르는 고통도 균이 만드는 게 '
                      ...
                      '<b>부수적 손상</b>이라고 정리한다. 그리고 그 손상을 5년 10년 켜 둔 채로 두는 흔한 원인이 '
    ...
    'slim_points': [
        ...
        '<b>살이 찌면 지방 세포는 수가 아니라 부피가 커진다.</b> 세포가 빵빵해지면 지방산이 삐져나오고, 쓰이지 '
    ...
    'links': LINKS_EP155,
    'slim_oneliner': ('"밥은 괜찮은데 빵은 더 나쁘다"에 그는 전혀 맞지 않다고 답한다. 곡식은 분해되면 마지막에 '
                      '포도당만 남고, 포도당 자체는 문제가 없다. 정제 탄수화물이 나쁘다는 말은 사실 소화가 절반쯤 '
                      '끝난 상태라 <b>많이 먹게 된다</b>는 뜻이다. 그러니 확인도 느낌으로 하지 않는다. 집에서 '
                      '혈압과 허리둘레를 재고, 피검사에서 셋을 본다.'),
    'slim_points': [
        '<b>탄수화물은 염증 물질이 아니다.</b> 들어온다고 염증이 생기지 않는다. 너무 많이 들어와 보관하는 '
        '과정에서 생기는 일이 염증이 될 뿐이다.',

        '<b>정제 탄수화물이 맛있는 까닭이 곧 문제다.</b> 부드러운 빵과 흰쌀밥은 소화 과정을 이미 거친 상태라 몸이 '
        '편해한다. 더 잘게 쪼개 놓으면 단맛이 되고 설탕이 되고 디저트가 된다.',
    ...
    'figs': [
        ...
        (12, '그림 4 · 무엇을 어디서 재나',
         FIG_MEASURE,
         '다섯 가지 모두 느낌이 아니라 숫자로 잡는다. 아프기 전에 움직이자는 게 목적이라, 검사에서 정상이라고 '
...
HEADER = '''  <header>
    ...
    <h1>건강 인사이트</h1>
    <p class="lede">채널을 가리지 않고 <b>몸에서 실제로 벌어지는 일</b>만 모읍니다. 카드는 영상이 아니라 주제로
