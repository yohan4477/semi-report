...
CAPTION = {
    ...
    'SHARE': ('광 부품이 차지하는 비중 — 클러스터에서 모듈까지', cf.FIG_SHARE,
              '막대 하나가 100% 이고 짙은 조각이 그 줄의 대상입니다. 클러스터 총비용에서 네트워킹은 15% 이고 '
              '그 안에서 트랜시버가 60% 입니다(원문은 클러스터 대비 몇 % 인지는 안 적었습니다). 클러스터 '
              '총전력에서 네트워킹은 9%, 광트랜시버는 435MW 중 17MW 입니다. 트랜시버 한 개 안에서는 DSP 가 '
              '전력의 약 절반, 자재비의 20~30% 입니다. 전부 SemiAnalysis 추정(2026-01, GB300 NVL72 20만 대 3층망 기준)입니다.'),
