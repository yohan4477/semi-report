...
CAPTION = {
    ...
    'POWER': ('800G 한 개 — 트랜시버와 CPO 광엔진의 전력', cf.FIG_POWER,
              'SemiAnalysis 추정(2026-01)입니다. 막대 높이는 값에 비례하고 범위는 위 끝입니다.'),
...
LEAD = ('이 층은 물음 하나를 세 묶음으로 따라갑니다 — 왜 빛인가, 어디부터 쓰이나, 누가 서 있고 무엇이 남았나.')


def toc_html(titles):
    """규약과 코드는 _rep_toc 하나뿐이다 — 층마다 복사하면 갈린다(2026-09-05)."""
    return rt.toc_html('cpo', LEAD, GROUPS, titles)
