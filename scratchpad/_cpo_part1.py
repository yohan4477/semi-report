...
CAPTION = {
    ...
    'POWER': ('트랜시버 하나는 73% 줄지만 클러스터 전체는 2~4%다', cf.FIG_POWER,
              'SemiAnalysis 추정(2026-01)입니다. 왼쪽은 800G 모듈 한 개의 와트, 오른쪽은 GB300 NVL72 '
              '20만 대 클러스터의 메가와트입니다. 광트랜시버가 435MW 중 17MW 라서, 그것을 73% 줄여도 '
              '전체로는 2~4% 입니다. 막대 높이는 값에 비례하고 왼쪽은 와트, 오른쪽은 메가와트입니다.'),
