...
LAYERS = [
    ('sec-phys', '2026-09-17',
     ...
     'InferenceX 실행 요약 파일 769행 · 원문 칩 규격 · HF 파라미터 수',
     '모델 KV 구조에 따라 세션 수가 13.9배 갈리고, HBM 여유 용량과 DRAM·SSD 층이 그 뒤를 잇는다',
     rp.report_model_axm_html),
    ('sec-cost', '2026-09-17',
     '베라 루빈 에이전틱 추론 — 원문 숫자 28칸이 공개 데이터에서 그대로 나오고, 「67배」는 곡선 끝 1.4 TPS 에 걸려 있다',
     'SemiAnalysis 영문 2편 · InferenceX 공개 측정 행 · 대시보드 앱 코드',
     '같은 사용자 속도에서 1메가와트당 토큰은 일곱 설정이 다 맞고, 67배는 170 이 아니라 171.4 TPS 에서 나온다',
     rp.report_model_ax_html),
    ('sec-meet', '2026-09-10',
     '받은 엑셀 — 시트 그대로 보기',
    ...
    ('sec-fin', '2026-09-12',
     ...
     'SemiAnalysis 영문 1편의 본문 값 · 앞 두 글의 단가',
     '10-Q 의 부담을 계약 둘로 다시 내면 7월 글의 전력과 다리 층의 자본 단가가 같은 자리에서 나온다',
     rp.report_model_bs_html),
    ('sec-fin', '2026-09-10',
