...
STACK = ['전자·공정', '칩', 'HBM', '일반 D램', '낸드·스토리지', '열', '랙', '데이터센터', '전력망', '연료·지정학']
# 스택 의존 그래프 — 인사이트는 여기서 서로 이어진 노드들만 묶을 수 있다(아무 데나 잇는 것을 막는다)
EDGES = [('전자·공정', '칩'), ('칩', 'HBM'), ('칩', '일반 D램'), ('HBM', '일반 D램'),
         ('일반 D램', '낸드·스토리지'), ('칩', '열'), ('칩', '랙'), ('열', '랙'),
         ('HBM', '랙'), ('일반 D램', '랙'), ('낸드·스토리지', '랙'),
         ('랙', '데이터센터'), ('데이터센터', '전력망'), ('전력망', '연료·지정학')]
