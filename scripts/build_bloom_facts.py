...
O = [
 ...
 # 매출 갈래 안에서 고객 이름이 붙지 않은 잔여. 이 돈을 AEP·오라클로 옮기지 않는다
 ('o-rev-product-unalloc-fy2025', 'bloom-rev-product', 'unallocated_customer_amount',
  721.481, None, None, USDM, 'FY2025', '2025-01-01', '2025-12-31', '2026-02-09',
  'Bloom FY2025 제품 매출 15억 3,128만 달러', 'HISTORICAL', 'CONFIRMED', 1.0, None,
  ['be_10k_fy2025'], '펀드 JV 로 확인된 제품 금액을 뺀 나머지'),
 ('o-rev-install-unalloc-fy2025', 'bloom-rev-installation', 'unallocated_customer_amount',
  151.768, None, None, USDM, 'FY2025', '2025-01-01', '2025-12-31', '2026-02-09',
  'Bloom FY2025 설치 매출 2억 410만 달러', 'HISTORICAL', 'CONFIRMED', 1.0, None,
  ['be_10k_fy2025'], '펀드 JV 로 확인된 설치 금액을 뺀 나머지'),
 ('o-rev-service-unalloc-fy2025', 'bloom-rev-service', 'unallocated_customer_amount',
  228.295, None, None, USDM, 'FY2025', '2025-01-01', '2025-12-31', '2026-02-09',
  'Bloom FY2025 서비스 매출 2억 2,830만 달러', 'HISTORICAL', 'CONFIRMED', 1.0, None,
  ['be_10k_fy2025'], '서비스는 고객별 배분이 공개되지 않는다'),
 ('o-rev-elec-unalloc-fy2025', 'bloom-rev-electricity', 'unallocated_customer_amount',
  60.350, None, None, USDM, 'FY2025', '2025-01-01', '2025-12-31', '2026-02-09',
  'Bloom FY2025 전력 매출 6,035만 달러', 'HISTORICAL', 'CONFIRMED', 1.0, None,
  ['be_10k_fy2025'], '전력도 고객별 배분이 공개되지 않는다'),
...
CLAIMS = [
 ...
 ('clm-be-hitachi', '히타치가 일본에서 블룸 연료전지를 얹은 온사이트 전력을 데이터센터·산업 '
  '고객에게 대는 일을 함께 한다.', 'hitachi', 'bloom-energy', '2026-09~', 'CONFIRMED', 1.0,
  ['be_hitachi_japan'],
  '히타치는 기획·설계·제어 통합·운영 지원, 블룸은 연료전지와 기술 지원이다. 03 의 CLM053'),
 ('clm-be-omika', '히타치가 이바라키 오미카 공장에서 블룸 연료전지에 제 제어를 붙이는 실증을 '
  '마쳤다.', 'hitachi-omika-works', 'bloom-energy', '2026-09 이전', 'CONFIRMED', 1.0,
  ['be_hitachi_japan'],
  '원격 출력 조정과 상태 감시를 확인했다. 용량은 비공개라 상업 배치로 읽지 않는다. 03 의 CLM054'),
 ('clm-be-power-connect', '블룸이 전기 통합을 현장에서 공장으로 옮긴 Power Connect 를 내놓으며 '
  '현장 전기 설치 시간을 40% 넘게 줄인다고 밝혔다.', 'bloom-energy', None, '2026-08~',
  'CONFIRMED', 0.9, ['be_power_connect'],
  '회사가 밝힌 성능이다. 배전반·변압기 같은 부지 전기 공급사가 없어지는 것은 아니다. 03 의 CLM055'),
 ('clm-be-coseus-4gw', '코세스의 2026년 7월 1억 달러 전극셀 자동화 계약이 시험 라인에 이은 4GW '
  '양산 라인용이라는 2차 보도가 있다.', 'coseus', 'bloom-energy', '2026-07', 'INFERRED', 0.5,
  ['coseus_4gw_media'],
  '1억 달러를 4GW 로 나눠 공장 투자 단가로 읽지 않는다. 특정 자동화 장비 묶음이다. 03 의 CLM056'),
