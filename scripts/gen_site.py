...
PAGES = [
    ...
    # 2026-09-08 공개 사이트에서 뺐다. 유료 뉴스레터 변환본을 근거로 합치면서
    # 링크드인 공개 글만 재료였던 전제가 깨졌다. 원본과 생성기는 남아 있으니
    # 다시 세울 때 이 줄을 되살린다 — 되살릴 때는 잠금(True)으로 세운다.
    # ('링크드인 흐름.html', 'li-flow', '링크드인 흐름', '🔗',
    #  '여섯 달 흐름 — 병목은 칩이 아니라 그 바깥이었다', True),
...
REDIRECTS = {'finance': ('understanding', '산업/시장 인사이트'),
             # 2026-09-08 링크드인 흐름을 공개에서 뺐다. 이미 나간 주소는 살려 둔다
             'li-flow': ('semianalysis', 'SemiAnalysis')}
