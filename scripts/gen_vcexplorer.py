...
table.t tr.pick{cursor:pointer;-webkit-tap-highlight-color:rgba(20,26,40,.12);
transition:background .12s}
table.t tr.pick:hover{background:var(--hi)}
table.t tr.pick:active,table.t tr.pick.on{background:var(--ink1);color:#fff}
table.t tr.pick.on td,table.t tr.pick:active td{color:#fff}
...
pointer-events:none}
.busy i{width:15px;height:15px;border:2px solid var(--line);border-top-color:var(--ink1);
