...
R = [
 ...
 # ── 다운스트림: 직접 고객 ─────────────────────────────────────────
 ('bloom-oracle', 'be-rev-product', 'oracle', 'DIRECT_CUSTOMER', 'DOWNSTREAM', 'Data center',
 ...
 ('bloom-equinix', 'be-rev-product', 'equinix', 'DIRECT_CUSTOMER', 'DOWNSTREAM', 'Data center',
  'Energy Server', '제조사', '최종 사용자', '2025-02-20', None, 'ACTIVE', 'CONFIRMED',
  None, None, ['be_equinix_100mw'], None),
 ('bloom-nebius', 'be-rev-product', 'nebius', 'DIRECT_CUSTOMER', 'DOWNSTREAM', 'Data center',
  'AI 인프라용 Energy Server', '제조사', '최종 사용자', '2026-05-20', None, 'ACTIVE',
  'CONFIRMED', None, None, ['nebius_be_328mw'], None),
 ('bloom-coreweave', 'be-rev-product', 'coreweave', 'DIRECT_CUSTOMER', 'DOWNSTREAM', 'Data center',
  'Energy Server', '제조사', '최종 사용자', None, None, 'ACTIVE', 'CONFIRMED', None, None,
  ['be_10k_fy2025'], None),
 ('bloom-intel', 'be-rev-product', 'intel', 'DIRECT_CUSTOMER', 'DOWNSTREAM', 'Data center', 'Energy Server',
  '제조사', '최종 사용자', None, None, 'ACTIVE', 'CONFIRMED', None, None, ['be_10k_fy2025'], None),
 ('bloom-att', 'be-rev-product', 'att', 'DIRECT_CUSTOMER', 'DOWNSTREAM', 'Data center', 'Energy Server',
  '제조사', '최종 사용자', None, None, 'ACTIVE', 'CONFIRMED', None, None, ['be_10k_fy2025'], None),
 ('bloom-verizon', 'be-rev-product', 'verizon', 'DIRECT_CUSTOMER', 'DOWNSTREAM', 'Data center',
  'Energy Server', '제조사', '최종 사용자', None, None, 'ACTIVE', 'CONFIRMED', None, None,
  ['be_10k_fy2025'], None),
 ('bloom-quanta', 'be-rev-product', 'quanta-computer', 'DIRECT_CUSTOMER', 'DOWNSTREAM', 'C&I',
  'Energy Server', '제조사', '최종 사용자', '2024-01-01', None, 'ACTIVE', 'CONFIRMED',
  None, None, ['be_10k_fy2025'], 'AI 하드웨어 제조 시설 용량을 150% 이상 늘렸다'),
 ('bloom-walmart', 'be-rev-product', 'walmart', 'DIRECT_CUSTOMER', 'DOWNSTREAM', 'C&I', 'Energy Server',
  '제조사', '최종 사용자', None, None, 'ACTIVE', 'CONFIRMED', None, None, ['be_10k_fy2025'], None),
 ('bloom-homedepot', 'be-rev-product', 'home-depot', 'DIRECT_CUSTOMER', 'DOWNSTREAM', 'C&I', 'Energy Server',
  '제조사', '최종 사용자', None, None, 'ACTIVE', 'CONFIRMED', None, None, ['be_10k_fy2025'], None),
 ('bloom-ferrari', 'be-rev-product', 'ferrari', 'DIRECT_CUSTOMER', 'DOWNSTREAM', 'C&I', 'Energy Server',
  '제조사', '최종 사용자', None, None, 'ACTIVE', 'CONFIRMED', None, None, ['be_10k_fy2025'], None),
 ('bloom-fedex', 'be-rev-product', 'fedex', 'DIRECT_CUSTOMER', 'DOWNSTREAM', 'C&I', 'Energy Server',
  '제조사', '최종 사용자', None, None, 'ACTIVE', 'CONFIRMED', None, None, ['be_10k_fy2025'], None),
 # ── 익명 고객 ─────────────────────────────────────────────────────
