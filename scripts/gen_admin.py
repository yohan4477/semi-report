...
VIEWSTEPS = [
 ...
 ('3', '묻는다',
  ...
  ['전략 뷰는 「너는 시니어 경영전략 컨설턴트다」, 기술 뷰는 「너는 시니어 업계 기술 전문가다」',
   ...
   '뷰는 둘이다. 두 답을 합쳐 달라고 한 통합 뷰는 걷었다 — 혼자 가진 대목이 없었다'],
  ['scripts/prompts/{strategy,tech}.txt', 'scripts/gem_views.py'],
  ['묻는 자리']),
 ('4', '받는다',
 ...
 ('6', '싣는다',
  ...
  ['마크다운을 카드 마크업으로 옮긴다 — 제목·표·목록·문단',
   ...
   '섹션 머리 아래에는 회차에 붙는 줄만 선다 — 진행자·업로드·원제',
